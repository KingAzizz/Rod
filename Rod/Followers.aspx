<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Followers.aspx.cs" Inherits="Rod.Followers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="followContainer">
        <div>
            <div>
                  <asp:HyperLink ID="following" runat="server" Text="المتابعين" 
                    NavigateUrl="~/profile/following">
                </asp:HyperLink>
                <asp:HyperLink ID="follower" runat="server" Text="التابعين"
                    CssClass="selectedWindow" 
                    NavigateUrl="~/profile/followers">
                </asp:HyperLink>
            </div>
            <asp:ListView ID="FollowedProfileListView" runat="server" 
                OnItemDataBound="FollowedProfileListView_ItemDataBound"
                OnItemCommand="FollowedProfileListView_ItemCommand">
                <ItemTemplate>
            ...
            <div class="followProfile" dir="rtl">
                ...
                <asp:HiddenField ID="followerID" runat="server" Value='<%# Eval("followerID") %>' />
                <div class="unfollowDiv">
                    <asp:Button ID="unFollow" runat="server" Text="الغاء المتابعة" Visible="false" CommandName="unFollow" CommandArgument='<%# Eval("followerID") %>' />
                    <asp:Button ID="follow" runat="server" Text="متابعة" Visible="false" CommandName="follow" CommandArgument='<%# Eval("followerID") %>'/>
                </div>
            </div>
