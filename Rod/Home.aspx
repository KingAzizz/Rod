    ...
    <section class="homeNoLoggin" id="HideIfUserLoggedIn" runat="server">
        ...
        <section class="whyRod">
            ...
            <div>
                ...
                <p dir="rtl">ارتفعت الحاجة إلى مثل هذا التطبيق على شبكة الإنترنت استجابة لعدم وجود طرق للتواصل مفيده للمتعلمين.  يتم يستخدام تطبيقات مثل <span style="color:#25d366;">WhatsApp</span> و <span style="color:#0088CC;">Telegram</span>  لكن مميزاتها محدودة.
